...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DGC8X3XJ.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CmWvj2WA.js").then((n2) => n2.r),
    import("./start-BoIv0NyO.js"),
...
var ROUTER_BASEPATH = "justmyslide-dark-ai-launchpad";
var SERVER_FN_BASE = "/justmyslide-dark-ai-launchpad/_serverFn/";
