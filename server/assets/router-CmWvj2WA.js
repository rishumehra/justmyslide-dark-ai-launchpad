...
const appCss = "/justmyslide-dark-ai-launchpad/assets/styles-Bqf7pSvs.css";
...
const Route$3 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "JustMySlide builds AI workflows, UiPath RPA automation, and developer-grade technical documentation. Open-source friendly." },
      { name: "author", content: "JustMySlide" },
      { property: "og:title", content: "JustMySlide — AI, Automation & Documentation" },
      { property: "og:description", content: "AI workflow consulting, RPA with UiPath, technical writing, and open-source projects." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@JustMySlide" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter$2 = () => import("./index-DMwPjKQb.js");
const Route$2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AI workflow consulting, UiPath RPA automation, and developer-grade technical writing. Open-source projects including RishOS."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./blog.index-D-yL7DPJ.js");
const Route$1 = createFileRoute("/blog/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Field notes on AI workflows, UiPath RPA, and writing documentation developers actually read."
    }, {
      property: "og:title",
      content: "Blog — JustMySlide"
    }, {
      property: "og:description",
      content: "Field notes on AI, RPA, and developer documentation."
    }]
  })
});
const posts = [
...
const $$splitErrorComponentImporter = () => import("./blog._slug-CeYQEzSz.js");
const $$splitNotFoundComponentImporter = () => import("./blog._slug-Ds2xjV0S.js");
const $$splitComponentImporter = () => import("./blog._slug-BQYXym5R.js");
