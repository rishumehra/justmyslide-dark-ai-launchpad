import { a2 as getDefaultExportFromCjs, V as jsxRuntimeExports } from "./server-DE5gJENa.js";
import { R as Route, L as Link, p as posts } from "./router-CmWvj2WA.js";
import { c as createLucideIcon, N as Nav, F as Footer } from "./Footer-BITrlGsc.js";
...
function BlogPost() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 mx-auto max-w-3xl px-6 py-16 w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs text-muted-foreground", children: [
          post2.date,
          " · ",
          post2.readTime
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 text-4xl md:text-5xl font-semibold tracking-tight leading-tight", children: post2.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap gap-2", children: post2.tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] px-2 py-0.5 rounded-full border border-border text-muted-foreground", children: [
          "#",
          t
        ] }, t)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose-content mt-10 text-foreground/90 leading-relaxed space-y-5\n            [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:mt-10 [&_h2]:mb-2\n            [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:mt-8\n            [&_p]:text-foreground/85\n            [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:list-decimal [&_ol]:pl-6\n            [&_code]:font-mono [&_code]:text-sm [&_code]:bg-surface-elevated [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:border [&_code]:border-border\n            [&_pre]:terminal-card [&_pre]:p-4 [&_pre]:overflow-x-auto [&_pre_code]:bg-transparent [&_pre_code]:border-0 [&_pre_code]:p-0\n            [&_strong]:text-foreground [&_a]:text-primary [&_a]:underline-offset-4 hover:[&_a]:underline", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { remarkPlugins: [remarkGfm], children: post2.body }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 border-t border-border pt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-sm text-muted-foreground", children: "Read more" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 grid gap-3 md:grid-cols-2", children: posts.filter((p) => p.slug !== post2.slug).slice(0, 2).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: {
          slug: p.slug
        }, className: "terminal-card p-4 hover:border-primary/40 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs text-muted-foreground", children: p.date }),
